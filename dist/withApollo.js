...
function withApollo(client, options) {
    ...
    return function (Page, pageOptions) {
        ...
        var getDataFromTree = 'getDataFromTree' in pageOptions ? pageOptions.getDataFromTree : options.getDataFromTree;
        ...
        WithApollo.displayName = "WithApollo(".concat(getDisplayName(Page), ")");
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            apollo = (0, apollo_1.default)(client, {
                                ctx: ctx,
                                headers: headers,
                                router: router
                            });
                        ...
                        case 7:
                            ...
                            return [2 /*return*/, __assign(__assign({}, pageProps), { apolloState: apolloState, apollo: apollo })];
                    }
                });
            }); };
        }
