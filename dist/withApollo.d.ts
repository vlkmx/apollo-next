...
export default function withApollo<TCache = any>(client: InitApolloClient<TCache>, options?: WithApolloOptions): (Page: NextPage<any> | typeof App, pageOptions?: WithApolloOptions) => {
